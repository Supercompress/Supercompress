...
## Corpus Check
- 28 files · ~56,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 452 nodes · 724 edges · 23 communities
...
Cohesion: 0.05
Nodes (40): pkg, express, bin, supercompress, supercompress-mcp, dependencies, express, description (+32 more)
...
Cohesion: 0.17
Nodes (12): keywords, aider, claude-code, codex, coding-agents, context-compression, cursor, llm-cost (+4 more)
